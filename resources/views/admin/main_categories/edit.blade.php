...
{{--                                        ده جزء ال form الاساسيه بتاع تعديل لغه ال default
{{-- --}}
                                        <form class="form"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> اسم القسم
                                                                - {{__('message.'.$mainCategory -> translation_lang)}} </label>
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> أختصار
                                                                اللغة {{__('message.'.$mainCategory -> translation_lang)}} </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">الحالة {{__('message.'.$mainCategory -> translation_lang)}} </label>
...
{{--                                  ده جزء التابات بتاع باقي اللغات --}}
...
{{--    aria-expanded  and  @if($index ==  0) active @endif   في اال  nav-link
  ده علشان اول ما ادخل الصفحه يكون مفعل اول لغه تحت اول م ادخل --}}
                                                            ...
                                                            <div class="form-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="projectinput1"> اسم القسم
                                                                                - {{__('message.'.$translation -> translation_lang)}} </label>
                                                                            <input type="text" id="name"
                                                                                   class="form-control"
                                                                                   placeholder="  "
                                                                    ...
                                                                    <div class="col-md-6 hidden">
                                                                        <div class="form-group">
                                                                            <label for="projectinput1"> أختصار
                                                                                اللغة {{__('message.'.$translation -> translation_lang)}} </label>
                                                                            <input type="text" id="abbr"
                                                                                   class="form-control"
                                                                                   placeholder="  "
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group mt-1">
                                                                            ...
                                                                            <label for="switcheryColor4"
                                                                                   class="card-title ml-1">الحالة {{__('message.'.$translation -> translation_lang)}} </label>
