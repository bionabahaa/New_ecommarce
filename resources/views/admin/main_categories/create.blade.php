...
{{--       hidden : حطيت للكلاس  علشان ميظهرش في ال form
    انا هنا علشان خفيت ال field ده علشان الادمن مش هيبقي حافظ كل الاختصارات بتاعت اللغه وبتالي جبت قيمته من abbr وهو يحطها علظول --}}
                                                                           value="{{$lang -> abbr}}"
